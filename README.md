...
　　这里是民间网站‘老生常谈’，以[大规模集成网页(LSIP)](https://cn.bing.com/search?q=大规模集成网页){:target="_blank"}⇗为中文基础网站创作**高质量**的“结构性目录”。主要收录：法律、政务(经济/民生)、新闻、全球化等四大系列的官方网址。这些官网大多承担了信息披露的法定职责，构成了‘数字中国’的基础软件设施。大萌为这些官方网址**设计**容易检索的集成网页，希望能为网民“快速找到有效信息”节约时间。　本站结构性目录如下，详细目录请进入各系列页面：
...
![感谢Github支持本站](thanks4github-90.png)<!-- http://loucypher.github.io/images/octocat.png -->
	...
	https://Laosheng.top	v3.1.7 202307
