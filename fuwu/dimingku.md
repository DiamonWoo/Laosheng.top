...
　　县区级地名可查询本库；也可到[民政部网页](http://preview.www.mca.gov.cn/article/sj/xzqh/ )查询。


全国县区级重名统计
-------------------

　　初学者可以先看懂本库<全国县区级重名统计图>的select语句，对比我这里给出的更复杂的查询结果，尝试自己写出这个select语句。
<pre>
...
<img src="DBB-关于本库视图.png" height="720px" alt="严谨治学" />

```
	老生常谈之地名数据库 © 2021年5月 作者大萌
	GPL 3.0	可复制-可修改-原授权
	20210524	v0.9
```
